...
SIMPLE_JWT = {
    'ROTATE_REFRESH_TOKENS': True, # Nên để True
...
SECRET_KEY = 'django-insecure-4gbjy9vqtvmpy-88()q(ma0i=@s@+)dr13j30y1ltwb0gx(4-o'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'db',  # <--- SỬA THÀNH 'db' (tên service trong docker-compose.yml)
        'PORT': '5432',
    }
}
